...
const assets = ['index.html', 'src/app.js', 'src/game.js', 'src/events.js', 'src/style.css', 'src/version.js', 'src/i18n.js'];
...
await cp(new URL('src/locales/', root), new URL('src/locales/', output), { recursive: true });
